...
Open the following link and create a copy of the spreadsheet using File → Make a copy.

Refer to the guide below to create a Google service account.
...
Save the generated JSON credential file as:
...
Configure a scheduled job using crontab.
